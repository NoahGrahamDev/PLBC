        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <div className="flex items-center gap-3 mb-6">
              <div className="w-10 h-10 bg-[#ce6712] rounded-full flex items-center justify-center">
                <span className="text-white font-bold">PLBC</span>
              </div>
              <div>
          ...
          <div>
            ...
            <div className="space-y-3 text-gray-300 font-[var(--font-open-sans)]">
              <div className="flex items-start gap-3">
                <svg className="w-5 h-5 text-[#ce6712] mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
